...
#include "AmbientLightSensor/ALS.h"
...
static const CLI_Command_Definition_t xTemp = {"temp", "temp: Return temp from SHTC3\r\n", (const pdCOMMAND_LINE_CALLBACK)CLI_temp, 0};
static const CLI_Command_Definition_t xCalcAndSend = {"send", "send: Send Data to Node Red\r\n", (const pdCOMMAND_LINE_CALLBACK)CLI_SendData, 0};
static const CLI_Command_Definition_t xPIR = {"pir", "pir: Check for Motion\r\n", (const pdCOMMAND_LINE_CALLBACK)CLI_PIRCheck, 0};
static const CLI_Command_Definition_t xLED = {"led", "led: Check for Motion\r\n", (const pdCOMMAND_LINE_CALLBACK)CLI_led, 0};
static const CLI_Command_Definition_t xAlsGetCommand =
{
	"als",
	"als: Returns lux values from ALS\r\n",
	(const pdCOMMAND_LINE_CALLBACK)CLI_GetAlsData,
	0
};
